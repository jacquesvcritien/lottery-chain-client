...
export const createRPCQueryClient = async ({
  ...
  return {
    cosmos: {
      ...
      distributionNew: {
        v1beta1: (await import("../cosmos/distributionNew/v1beta1/query.rpc.Query")).createRpcQueryExtension(client)
      },
      feegrant: {
    ...
    lottery: {
      lottery: (await import("./lottery/query.rpc.Query")).createRpcQueryExtension(client)
    }
  };
};