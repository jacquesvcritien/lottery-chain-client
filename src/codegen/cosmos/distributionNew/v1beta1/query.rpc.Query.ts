...
export interface Query {
  ...
  /**
   * NEW
   * DelegatorLotteryReward queries the validators of a delegator.
   */
  delegatorLotteryReward(request: QueryDelegatorLotteryRewardRequest): Promise<QueryDelegatorLotteryRewardResponse>;
}
export class QueryClientImpl implements Query {
  ...
  constructor(rpc: Rpc) {
    ...
    this.delegatorLotteryReward = this.delegatorLotteryReward.bind(this);
  }
  params(request: QueryParamsRequest = {}): Promise<QueryParamsResponse> {
    const data = QueryParamsRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "Params", data);
    return promise.then(data => QueryParamsResponse.decode(new BinaryReader(data)));
  }
  validatorDistributionInfo(request: QueryValidatorDistributionInfoRequest): Promise<QueryValidatorDistributionInfoResponse> {
    const data = QueryValidatorDistributionInfoRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "ValidatorDistributionInfo", data);
  ...
  validatorOutstandingRewards(request: QueryValidatorOutstandingRewardsRequest): Promise<QueryValidatorOutstandingRewardsResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "ValidatorOutstandingRewards", data);
  ...
  validatorCommission(request: QueryValidatorCommissionRequest): Promise<QueryValidatorCommissionResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "ValidatorCommission", data);
  ...
  validatorSlashes(request: QueryValidatorSlashesRequest): Promise<QueryValidatorSlashesResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "ValidatorSlashes", data);
  ...
  delegationRewards(request: QueryDelegationRewardsRequest): Promise<QueryDelegationRewardsResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "DelegationRewards", data);
  ...
  delegationTotalRewards(request: QueryDelegationTotalRewardsRequest): Promise<QueryDelegationTotalRewardsResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "DelegationTotalRewards", data);
    return promise.then(data => QueryDelegationTotalRewardsResponse.decode(new BinaryReader(data)));
  }
  delegatorValidators(request: QueryDelegatorValidatorsRequest): Promise<QueryDelegatorValidatorsResponse> {
    const data = QueryDelegatorValidatorsRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "DelegatorValidators", data);
  ...
  delegatorWithdrawAddress(request: QueryDelegatorWithdrawAddressRequest): Promise<QueryDelegatorWithdrawAddressResponse> {
    ...
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "DelegatorWithdrawAddress", data);
    return promise.then(data => QueryDelegatorWithdrawAddressResponse.decode(new BinaryReader(data)));
  }
  communityPool(request: QueryCommunityPoolRequest = {}): Promise<QueryCommunityPoolResponse> {
    const data = QueryCommunityPoolRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "CommunityPool", data);
    return promise.then(data => QueryCommunityPoolResponse.decode(new BinaryReader(data)));
  }
  delegatorLotteryReward(request: QueryDelegatorLotteryRewardRequest): Promise<QueryDelegatorLotteryRewardResponse> {
    const data = QueryDelegatorLotteryRewardRequest.encode(request).finish();
    const promise = this.rpc.request("cosmos.distributionNew.v1beta1.Query", "DelegatorLotteryReward", data);
    return promise.then(data => QueryDelegatorLotteryRewardResponse.decode(new BinaryReader(data)));
  }
}
export const createRpcQueryExtension = (base: QueryClient) => {
  ...
  return {
    ...
    delegatorLotteryReward(request: QueryDelegatorLotteryRewardRequest): Promise<QueryDelegatorLotteryRewardResponse> {
      return queryService.delegatorLotteryReward(request);
    }
  };
};